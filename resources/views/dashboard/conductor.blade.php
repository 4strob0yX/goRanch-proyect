...
<style>
    ...
    /* ── Sidebar ── */
    .sidebar { background: #0c1509; border-right: 1px solid rgba(255,255,255,.06); position: fixed; top: 0; left: 0; height: 100vh; width: 260px; display: flex; flex-direction: column; z-index: 50; }
